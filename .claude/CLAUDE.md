...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-30. Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.58/10 avg, hotspot health 8.58/10 (stable), worst `app.js` at 8.0/10 · maintainability 7.25/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
